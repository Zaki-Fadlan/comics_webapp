<nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-500"
        ...
        x-transition:leave-end="opacity-0 transform scale-95" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="comics"
                ...
                Comics</a>
            <a href="/bookmarks"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Bookmarks</a>
            <a href="/historty"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">History</a>
        </div>
