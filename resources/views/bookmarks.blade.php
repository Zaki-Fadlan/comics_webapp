<x-layout>
    ...
    <section class="my-2 p-6 bg-white dark:bg-gray-900 antialiased not-format mb-4">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Bookmark list</h2>
        </div>
        <div class="w-full">
            <form class="flex items-center">
                <label for="simple-search" class="sr-only">Search comics</label>
                <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search"
                        ...
                        placeholder="Search comics" required="">
                </div>
            </form>
        </div>
